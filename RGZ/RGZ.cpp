...
link:
	...
	cout << "Выберете стиль заполнения массива:" << endl <<
		"1.Упорядочный массив" << endl <<
		"2.Упорядочный массив в обратном порядке" << endl;
	cin >> selection;
	switch (selection)
	{
	case 1:
		...
		cout << "\nНажмите клавишу Enter для перехода на упорядочный массив..." << endl;
		_getch();
		system("cls");
		break;
		/////////////////////////////////////////////////////////
